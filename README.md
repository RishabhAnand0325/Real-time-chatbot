...
│   ├── main.py               # Entry point, WebSocket handler, and orchestration
│   ├── database.py           # Supabase async client and database queries
│   ├── llm_service.py        # Logic for OpenAI streaming and tool calling
│   ├── requirements.txt      # List of python dependencies
│   └── .env                  # Backend secrets (API keys)
│
└── frontend/                 # Next.js Frontend
    ├── app/
    │   ├── page.tsx          # Main layout and UI container
    │   └── globals.css       # Global styles and Tailwind imports
    ├── components/
    │   ├── ChatInterface.tsx # Core chat logic and WebSocket integration
    │   ├── MessageBubble.tsx # UI component for individual messages
